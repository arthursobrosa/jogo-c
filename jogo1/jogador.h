...
typedef struct
{
    ...
    //linha chegada
    bool podeContarVolta;
    //inimigo
    float tempoRotacaoRestante;
    bool estaVirando;
    bool viraSentidoHorario;
    bool estaDandoRe;
    float tempoDesdeSpawn;
} Jogador;
...
// Protótipo assumido (verifica colisão entre o carro e a célula 'L')
